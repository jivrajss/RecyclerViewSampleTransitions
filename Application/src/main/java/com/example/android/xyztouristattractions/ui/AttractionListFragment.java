...
//            holder.mBuildingType.setText(attraction.name);
//            holder.mLocation.setText(attraction.description);
//            Glide.with(mContext)
...
//                holder.mPrice.setText(distance);
//            }
        }
        ...
        public void onItemClick(View view, int position) {
            if (!mItemClicked) {
                mItemClicked = true;
                View heroView = view.findViewById(R.id.viewImage);
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder
        ...
        TextView mLocation;
        TextView mPrice;
        ImageView mShortlist;
        DynamicImageView mImageView;
        ItemClickListener mItemClickListener;

        public ViewHolder(View view, ItemClickListener itemClickListener) {
            super(view);
            mBuildingType = (TextView) view.findViewById(R.id.buildingType);
            mLocation = (TextView) view.findViewById(R.id.address);
            mPrice = (TextView) view.findViewById(R.id.cost);
            mShortlist = (ImageView) view.findViewById(R.id.shortlist);
            mImageView = (DynamicImageView) view.findViewById(R.id.viewImage);
